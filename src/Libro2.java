...
public class Libro2 {
    ...
    public Libro2(String titulo, String apellido, String nombre, float precio, String editorial, String isbn,
    ...
    public String toString() {
        return titulo +" "+ apellido + " " + nombre + " " + precio + " " + editorial + " " +isbn+" "+fechaCopyright+" "+numEjemplares+" "+estado;
    }
